...
export const state: RenderState = {
  ...
  interiorDetail: interiorDetailInput.checked,
  interiorNoiseMode: interiorNoiseModeInput.value as 'single' | 'fractal',
  interiorNoiseStrength: Number(interiorNoiseStrengthInput.value),
