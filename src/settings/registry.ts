...
export const SECTIONS: SettingSectionDefinition[] = [
  { id: 'fractal', title: 'Fractal', defaultCollapsed: false },
  { id: 'rendering', title: 'Rendering', defaultCollapsed: false },
  { id: 'optimizations', title: 'Optimizations', defaultCollapsed: true },
  { id: 'cache', title: 'Tile cache', defaultCollapsed: true },
  { id: 'color-palette', title: 'Color palette', defaultCollapsed: false  },
  { id: 'palette-range', title: 'Palette range', defaultCollapsed: false  },
  { id: 'adjust-colors', title: 'Adjust colors', defaultCollapsed: false  },
  { id: 'color-animation', title: 'Color animation', defaultCollapsed: false },
  { id: 'canvas', title: 'Canvas', defaultCollapsed: true },
  { id: 'view', title: 'View', defaultCollapsed: true },
  { id: 'zoom', title: 'Zoom', defaultCollapsed: true },
  { id: 'perturbation', title: 'Perturbation', defaultCollapsed: true  },
  { id: 'precision', title: 'Precision', defaultCollapsed: true  },
  { id: 'fly-to', title: 'Fly to', defaultCollapsed: true },
];
...
export const coreSettings: SettingDefinition[] = [
  ...
  // --- Optimizations ---
  { id: 'solidGuessing', kind: 'checkbox', label: 'Solid interior guessing', section: 'optimizations', default: true, rerender: true },
  { id: 'geometricCulling', kind: 'checkbox', label: 'Geometric culling', section: 'optimizations', default: true, rerender: true },
  { id: 'periodicityChecking', kind: 'checkbox', label: 'Periodicity checking', section: 'optimizations', default: true, rerender: true },

  // --- Cache ---
  {
    id: 'tileCacheSize', kind: 'number', label: 'Max cached', section: 'cache',
  ...
  },
  {
    ...
    id: 'colorCacheSize', kind: 'number', label: 'Max colored', section: 'cache',
    default: 2000, min: 64, max: 20000, step: 64, rerender: false,
  ...
  { id: 'autoAdjustColors', kind: 'checkbox', label: 'Auto-adjust palette', section: 'palette-range', default: true, rerender: false, onChange: () => cheapRecolorRepaint() },
    {
    id: 'paletteMinIterations', kind: 'slider', label: 'Min iterations', section: 'palette-range',
    default: 0, min: 0, max: 2000, step: 8, rerender: false,
    onChange: () => cheapRecolorRepaint(),
    rangeLink: { role: 'min', pairedWith: 'paletteMaxIterations' },
    },
    {
    id: 'paletteMaxIterations', kind: 'slider', label: 'Max iterations', section: 'palette-range',
  ...
  {
    id: 'animationSpeed', kind: 'slider', label: 'Speed', section: 'color-animation',
  ...
  // --- Canvas ---
  {
    id: 'width', kind: 'number', label: 'Width', section: 'canvas',
  ...
  {
    id: 'height', kind: 'number', label: 'Height', section: 'canvas',
  ...
  {
    id: 'fillViewport', kind: 'checkbox', label: 'Fill screen', section: 'canvas',
  ...
  { id: 'zoomSensitivity', kind: 'slider', label: 'Sensitivity', section: 'zoom', default: 3, min: 0.01, max: 5, step: 0.01, rerender: false, format: (v) => v.toFixed(1) },
  {
  ...
  {
    id: 'zoomPreviewDepthMode', kind: 'select', label: 'Preview depth', section: 'zoom', default: 'limited', rerender: false,
    options: [
  ...
  {
    id: 'zoomPreviewDepthOctaves', kind: 'number', label: 'Max depth', section: 'zoom',
    default: 4, min: 1, max: 32, step: 1, rerender: false,
    visibleWhen: (s) => s.zoomPreviewDepthMode === 'limited',
  },
  {
    id: 'zoomPreviewMinCoverage', kind: 'slider', label: 'Min coverage', section: 'zoom',
  ...
  {
    id: 'zoomLookAheadLevels', kind: 'number', label: 'Levels', section: 'zoom',
  ...
  {
    id: 'zoomLookBehindLevels', kind: 'number', label: 'Levels', section: 'zoom',
    default: 2, min: 0, max: 12, step: 1, rerender: false,
    visibleWhen: (s) => s.zoomLookBehind === true,
  },
  {
    id: 'zoomLookAheadSpacing', kind: 'select', label: 'Spacing', section: 'zoom', default: 'step', rerender: false,
    options: [
  ...
  {
    id: 'zoomLookPriority', kind: 'select', label: 'Render order', section: 'zoom', default: 'direction', rerender: false,
    options: [
...

{
  ...
  {
  id: 'seriesValidityMode', kind: 'select', label: 'Validity check', section: 'perturbation',
...
{
    id: 'seriesToleranceMode', kind: 'select', label: 'Tolerance Type', section: 'perturbation',
  ...
  {
    id: 'seriesTolerance', kind: 'slider', label: 'Tolerance', section: 'perturbation',
  ...
  {
    id: 'precisionMode', kind: 'select', label: 'Backend', section: 'precision',
  ...
  {
    id: 'flyToPerOctaveMs', kind: 'slider', label: 'Octave (ms)', section: 'fly-to',
    default: 900, min: 0, max: 8000, step: 50, rerender: false, format: (v) => `${(v / 1000).toFixed(2)} s`,
  },
  {
    id: 'flyToBaseMs', kind: 'slider', label: 'Base (ms)', section: 'fly-to',
    default: 400, min: 0, max: 10000, step: 50, rerender: false, format: (v) => `${(v / 1000).toFixed(2)} s`,
  },
  {
    id: 'flyToMinMs', kind: 'slider', label: 'Min (ms)', section: 'fly-to',
  ...
  },
  {
    ...
    id: 'flyToMaxMs', kind: 'slider', label: 'Max (ms)', section: 'fly-to',
